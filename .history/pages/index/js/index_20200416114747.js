...
　　　},
    ...
    createYiBao(){
       ...
       $.each(con__ybCon,function(index,ele){
           ...
           var colorTemplate1 = [[1, "rgba(41,114,248,1)"], [1, "rgba(41,114,248,1)"], [1, "rgba(41,114,248,1)"]];
           let opt =    {
    ...
    createOne(xdata1,ydata1,xdata2,ydata2){
        let _this = this;
        let myChart1 = echarts.init(document.getElementById("zexian1"));
        let opt1 = {
          grid: {
              x: "16%",//x 偏移量
              y: "7%", // y 偏移量
    ...
    createTwo(xdata1,ydata1){
        ...
        let _this = this;
        let myChart1 = echarts.init(document.getElementById("zexian2"));
        let opt = {
          grid: {
              x: "16%",//x 偏移量
              y: "7%", // y 偏移量
    ...
    createThr(xdata1,ydata1){
        let _this = this;
        let myChart1 = echarts.init(document.getElementById("zexian3"));
        let opt = {
          grid: {
              x: "16%",//x 偏移量
              y: "7%", // y 偏移量
