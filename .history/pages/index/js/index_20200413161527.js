...
　　　},
    ...
    async getData(path){
       ...
       let  { jzxNum ,spNum,dzwlNum,cbNum,cbNumMonth,clNum,clNumMonth,jzxSpreadX,jzxSpreadY,jzxTrendX,jzxTrendY,cbTrendX,cbTrendY,clTrendX,clTrendY}  = data;
    ...
    createOne(xdata1,ydata1,xdata2,ydata2){
        ...
        myChart2.setOption({
              ...
              color:['#f6ba53','#f55b72','#396edb','#46cecb','#56c762','#f6ba53'],
              series: [
                  {
                      name: '访问来源',
                      type: 'pie',
