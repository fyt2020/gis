        ...
        this.getData(window.baseUrl.wlznSumNumUrl)
          .then((res) => {
           ...
           <span class="right__wlzbW">
              ...
              <span class="right__wlzbWR" id="user">${ele.valueone}</span>
           </span>
           <span class="right__wlzbW">
             <span class="right__wlzbWL">当天实时上下业务量累计数量:</span>
              <span class="right__wlzbWR" id="yewu">${ele.valueTwo}</span>
           </span>
           <span class="right__wlzbW">
             <span class="right__wlzbWL">上行PRB实时利用率:</span>
              <span class="right__wlzbWR" id="PRB1">${ele.valueThr}</span>
           </span>
           <span class="right__wlzbW">
             <span class="right__wlzbWL">下行PRB实时利用率:</span>
              <span class="right__wlzbWR" id="PRB2">${ele.valuefour}</span>
           </span> 
        </li>`;
            });
