...
　　　},
    ...
    createViewByJzx(){
        ...
        if(this.form === '101'&& this.type === 'total'){
          ...
          <ul class="right__infoCon">
          <li class="right__infoItem">
            <span class="right__itemTitle">提单号</span>
            <span class="right__itemCon">OOLUEZIA03187</span>
          </li>
     </ul>`;
          console.log(this.obj.jzxSumData)
          $('.right__info').prepend(STR);

          $.each(this.obj.jzxSumData,(ele,index) => {
