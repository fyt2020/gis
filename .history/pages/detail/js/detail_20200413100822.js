    ...
    createViewByJzx(){
       let _this = this;
        ...
        if(this.form === '101'&& this.type === 'total'){
            this.getData('../../../data/detail/jzxData.json').then((res)=>{

              let { jzxNum , jzxSpreadX , jzxSpreadY,jzxTrendX ,jzxTrendY ,jzxSumData} = res
              _this.jzxSumData = jzxSumData;
              console.log(_this.jzxSumData)
