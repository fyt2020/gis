(function (window, $, doc) {
  ...
  Star.prototype = {
    ...
    createEcha__jxz(sanX, sanY, zexianX, zexianY) {
      ...
      setInterval(()=>{
        let sanY =[_this.getRange(5000,30000),_this.getRange(5000,30000),_this.getRange(5000,30000),_this.getRange(5000,30000),_this.getRange(5000,30000)];
    ...
    createEcha__cl(zexianX, zexianY) {
      ...
      setInterval(()=>{
        let sanY =[_this.getRange(40,70),_this.getRange(40,70),_this.getRange(40,70),_this.getRange(40,70),_this.getRange(40,70)];
    ...
    createEcha__cb(zexianX, zexianY) {
      ...
      myChart2.setOption(opt);
      setInterval(()=>{
        let sanY =[_this.getRange(5,30),_this.getRange(5,30),_this.getRange(5,30),_this.getRange(5,30),_this.getRange(5,30)];
        opt.series[0].data = sanY;
        myChart2.setOption(opt, true);
      },5000)
