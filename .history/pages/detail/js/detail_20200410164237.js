...
(function(window,$,doc) {
    var Star = function(){   
        ...
        spNumTitle1:'港口摄像头总数',
        spNumVal1:'500',
        spXdata1:[  {value: 1000, name: '闸口区'},
        {value: 500, name: '自动驾驶区'},
        {value: 234, name: '危险物品区'},
        {value: 135, name: '电子围栏区'},
        {value: 400, name: '智能理货作业区'},
        {value: 400, name: '港机控制作业区'}],
        spYdata1: ['闸口区', '自动驾驶区','危险物品区','电子围栏区','智能理货作业区','港机控制作业区'],
        spSumData:[{
            title:'品牌',
            value:'OOLUEZIA03187'
        },
...
　　　},
    ...
    createViewBySp(){
        ...
        if(this.form === '103'&& this.type === 'total'){            // this.navArr[2].src = '../../../css/img/sp.png';
            ...
            <span class="num__num">${this.obj.spNumVal1}</span>`
            $('#right__num').prepend(str).css({display:'flex'});
          ...
          $('.right__info').prepend(STR);
          let str1 = ''
          $.each(this.obj.spSumData,(index,ele) => {
            str1 = str1 + `<li class="right__infoItem">
            <span class="right__itemTitle">${ele.title}</span>
            <span class="right__itemCon">${ele.value}</span>
            </li>`;
    ...
    createEcha__sp(){
        ...
        myChart1.setOption({
            ...
            legend: {
                ...
                data: this.obj.spYdata1
            },
            color:['#f6ba53','#f55b72','#396edb','#46cecb','#56c762','#56c762'],
            series: [
                {
                    name: '访问来源',
                    type: 'pie',
     ...
     */
     ...
     handleSwitch(){
        switch(this.form){
            case '101':
            $(this.navArr[0]).removeClass('detail__navTag').addClass('detail__navTag1')
            this.navArr[0].src = '../../../css/img/jzx.png';
            this.createViewByJzx()
            break;
            case '102':
            $(this.navArr[1]).removeClass('detail__navTag').addClass('detail__navTag1')
            this.navArr[1].src = '../../../css/img/cl.png';
            this.createViewByCl()
            break;
            case '103':
            $(this.navArr[2]).removeClass('detail__navTag').addClass('detail__navTag1')
            this.navArr[2].src = '../../../css/img/sp.png';
            this.createViewBySp()
            break;
            case '104':
            $(this.navArr[3]).removeClass('detail__navTag').addClass('detail__navTag1')
            this.navArr[3].src = '../../../css/img/cbl.png';
            this.createViewByCb()
            break;
            case '105':
            $(this.navArr[4]).removeClass('detail__navTag').addClass('detail__navTag1')
            this.navArr[4].src = '../../../css/img/dzwl.png';
    ...
    reSetNav(){
        this.navArr.each((index,ele)=>{
            ...
            $(ele).removeClass("detail__navTag1").addClass('detail__navTag');
        })
