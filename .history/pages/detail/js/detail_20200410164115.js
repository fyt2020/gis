...
　　　},
     ...
     */
     ...
     handleSwitch(){
        switch(this.form){
            case '101':
            $(this.navArr[0]).removeClass('detail__navTag').addClass('addClass1')
            this.navArr[0].src = '../../../css/img/jzx.png';
            this.createViewByJzx()
            break;
            case '102':
            $(this.navArr[1]).removeClass('detail__navTag').addClass('addClass1')
            this.navArr[1].src = '../../../css/img/cl.png';
            this.createViewByCl()
            break;
            case '103':
            $(this.navArr[2]).removeClass('detail__navTag').addClass('addClass1')
            this.navArr[2].src = '../../../css/img/sp.png';
            this.createViewBySp()
            break;
            case '104':
            $(this.navArr[3]).removeClass('detail__navTag').addClass('addClass1')
            this.navArr[3].src = '../../../css/img/cbl.png';
            this.createViewByCb()
            break;
            case '105':
            $(this.navArr[4]).removeClass('detail__navTag').addClass('addClass1')
            this.navArr[4].src = '../../../css/img/dzwl.png';
