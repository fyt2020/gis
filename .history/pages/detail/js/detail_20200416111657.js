(function (window, $, doc) {
  ...
  Star.prototype = {
    ...
    createEcha__jxz(sanX, sanY, zexianX, zexianY) {
      ...
      setInterval(()=>{
        let sanY =[{"value": _this.getRange(5000,30000), "name": "A区"},
        {"value": _this.getRange(5000,30000), "name": "B区"},
        {"value": _this.getRange(5000,30000), "name": "C区"},
        {"value": _this.getRange(5000,30000), "name": "D区"},
        {"value": _this.getRange(5000,30000), "name": "E区"}];
        opt1.series[0].data = sanY;
        myChart1.setOption(opt1, true);
      },5000)
