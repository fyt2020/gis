  ...
  Star.prototype = {
    ...
    createViewByCl() {
      if (this.form === "102" && this.type === "total") {
        ...
        this.getData("../../../data/detail/clSumData.json").then((res)=>{
    ...
    createViewBySp() {
      if (this.form === "103" && this.type === "total") {
         this.getData('../../../data/detail/spData.json').then((res)=>{
        ...
        this.getData('../../../data/detail/spSumData.json').then((res)=>{
           let { spSumData } = res;
    ...
    createViewByCb() {
      if (this.form === "104" && this.type === "total") {
        this.getData('../../../data/detail/cbData.json').then((res)=>{
      ...
      this.createEcha__cb(cbTrendX,cbTrendY);
        ...
        this.getData('../../../data/detail/cbSumData.json').then((res)=>{
